...
inline BOOL esos_uiF14_isSW3Pressed ESOS_TASK_WAIT_UNTIL_UIF14_RPG_MAKES_REV(void);
...
#define ESOS_TASK_WAIT_UNTIL_UIF14_RPG_MAKES_REV(y)                                                                    \
    {                                                                                                                  \
        _esos_ui_setLastRPGCounter_u16(_esos_uiF14_getRPGCounter()) ESOS_TASK_WAIT_UNTIL(                              \
